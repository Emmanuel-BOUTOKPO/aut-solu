...
export const getAllsPost = () => axiosIntance.get("/post/alls");
...
export const getPostByNew = () => axiosIntance.get("/post/getNew/");
export const getPostByFiltre = (filters) => axiosIntance.get("/post/getFitre/", {params : filters});
